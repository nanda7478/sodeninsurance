			...
			<?php if ( is_home() && ! is_front_page() ) : ?>
				<header class="entry-header-banner" style="background-image:url(<?php $banner_image = get_field( 'page_banner' ); ?> 
                    ...
                    <div class="shadow"></div>
						<?php $banner_image = get_field( 'page_banner', get_option('page_for_posts') ); ?> 
						<img src="<?php echo $banner_image['url']; ?>">
                        <div class="v-center">
					<div class="container">	
                    <div class="row">
							<div class="col-md-8">
                    <h1><?php the_field('page_banner_title', get_option('page_for_posts')) ?></h1>
						 <?php the_field('page_banner_content', get_option('page_for_posts')) ?> 
                         </div>
                         </div>
                         </div>
                         </div>
